...
import { Empleo } from '../model/models';
...
export class EmpleoService {
    ...
    /**
     * muestra un empleo definido por el ID categoria
     * @param categoriaId codigo del empleo
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getEmpleos(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<Array<Empleo>>;
    public getEmpleos(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<Array<Empleo>>>;
    public getEmpleos(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<Array<Empleo>>>;
    public getEmpleos(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.get<Array<Empleo>>(`${this.configuration.basePath}/Empleo`,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
